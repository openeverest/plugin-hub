...
// 'api/icon/<key>') for proxied icons; we prepend the host-supplied plugin
// base path (`/v1/clusters/{cluster}/plugins/{pluginName}`) so the URL is
// correct regardless of the current cluster or the release name the chart
// was installed under.
